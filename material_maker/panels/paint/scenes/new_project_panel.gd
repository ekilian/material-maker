...
@onready var paint_emission = $Darken/VBoxContainer/Settings/VBoxContainer/Panel/Margin/Grid/PaintEmission
@onready var paint_normal = $Darken/VBoxContainer/Settings/VBoxContainer/Panel/Margin/Grid/PaintNormal
@onready var paint_depth = $Darken/VBoxContainer/Settings/VBoxContainer/Panel/Margin/Grid/PaintDepth
@onready var paint_bump = $Darken/VBoxContainer/Settings/VBoxContainer/Panel/Margin/Grid/Bump/PaintBump
@onready var paint_bump_value = $Darken/VBoxContainer/Settings/VBoxContainer/Panel/Margin/Grid/Bump/BumpStrength
@onready var resolution = $Darken/VBoxContainer/Settings/VBoxContainer/Panel/Margin/Grid/Resolution/Resolution

@onready var model_file = $Darken/VBoxContainer/Project/Panel/Margin/GridContainer/ModelFile
@onready var mask_file = $Darken/VBoxContainer/Optionals/VBoxContainer/Panel/Margin/GridContainer/ChooseFile
@onready var project_filename = $Darken/VBoxContainer/Project/Panel/Margin/GridContainer/ProjectName

var _mesh_filename : String;
